...
const CreatePost = () => {
  ...
  <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
   Create imaginative and visual images through DALL-E AI and share the community
  </p>
  </div>
  ...
  <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
    ...
    <div className="relative bg-gray-50 border
     border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 
    ...
    <div className="mt-10">
    <p className="mt-2 text-[#666e] text-[14px]">
